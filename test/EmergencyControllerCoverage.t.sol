...
contract EmergencyControllerCoverageTest is Test {
    ...
    function test_GetApprovalStatus_OffsetBeyondApprovers() public {
        ...
        (uint256 _currentCount, uint256 _required, address[] memory page, uint256 nextOffset, uint256 total, bool _active, uint256 _executeAfter) = ec.getApprovalStatus(5, 10);
        assertEq(page.length, 0);
